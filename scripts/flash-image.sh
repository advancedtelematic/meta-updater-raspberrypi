...
if [ -z "$1" ]; then
  echo ""
  echo "   Flash a built, x-zipped image file onto a block device."
  echo ""
  ...
  echo "      Default: ./tmp/deploy/images/raspberrypi3/rpi-basic-image-raspberrypi3.rpi-sdimg-ota.xz"
  echo ""
...
DEVICE_TO_FLASH=$1
IMAGE_TO_FLASH="${2-tmp/deploy/images/raspberrypi3/rpi-basic-image-raspberrypi3.rpi-sdimg-ota.xz}"
...
xz --decompress --stdout $IMAGE_TO_FLASH | dd of=/dev/$DEVICE_TO_FLASH bs=32M && sync
sleep 2
